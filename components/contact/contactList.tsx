            ...
            <div className="flex">
                <div className="block">
                    ...
                    <div className="flex items-center justify-center space-x-15">
                        <Link href="https://github.com/IanMaze93"><Image  src="/github.png" alt="github icon" width={100} height={100}></Image></Link>
                        <Link href="https://www.linkedin.com/in/ian-maze-50943a194/"><Image src="/linkedin.png" alt="linkedin icon" width={100} height={100}></Image></Link>
                        <a href="mailto:mazeiandev@outlook.com"><Image src="/envelope.png" alt="linkedin icon" width={100} height={100}></Image></a>
                    </div>
                </div>
            </div>
        </div>
